...
void CCamera::SetViewByMouse()
{
	...
	int middleX = windowX2;				// This is a binary shift to get half the width
	int middleY = windowY2;				// This is a binary shift to get half the height
...
/////////// DOPISANE przez :  TOMASZ FIDOS
void CCamera::UpDownCamera(float speed)
{
	CVector3 a,b;
	a=Position();
	b=m_vView;
	a.y+=speed;
	b.y+=speed;
	PositionCamera(a.x, a.y, a.z,   a.x, a.y, a.x-6,   0, 1, 0);
	m_vView=b;
}

void CCamera::MoveCamera2(float speed)
{
	CVector3 a,b;
	a=Position();
	b=m_vView;
